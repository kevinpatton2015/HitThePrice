...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8" />
	<title>数码相机 - HitThePrice - 价格再低一点</title>
                    ...
                    <section id="maincontent" class="ten columns positionleft">
                    	<div class="padcontent">
                        	...
                        	<section class="content">
                                ...
                                <div class="breadcrumb"><a href="index.aspx">首页</a> / 摄影、摄像 / 数码相机 </div>
                   				<h1 class="pagetitle">数码相机</h1>
                                ...
                                <div id="product-list-container">
                                	...
                                	<div class="product-list-wrapper">
                                        <div class="one_fifth columns product-img">
                                            <a title="Olympus/奥林巴斯 Tough TG-5 防水数码相机深浮潜水tg5 三防水下" href="product-details.aspx"><img src="images/content/products/p-37.jpg" alt=""/></a>
                                        </div>
                                        <div class="three_fifth columns">
                                        	<div class="status"><span>品牌</span> &nbsp;&nbsp;| &nbsp;&nbsp;奥林巴斯</div>
                                            <h3><a title="Olympus/奥林巴斯 Tough TG-5 防水数码相机深浮潜水tg5 三防水下" href="product-details.aspx">Olympus/奥林巴斯 Tough TG-5 防水数码相机深浮潜水tg5 三防水下</a></h3>
                                            <p>淘宝网商城,旗舰品牌入驻,爆款手机,强劲配置,热卖机型,正品行货,性价比超高!网购手机,来「天猫手机馆」让人放心的手机商城.采购批发找电子产品<br />电子产品从原料,生产,加工一系列服务.找阿里巴巴,全球领先采购批发平台.<br />深圳 &nbsp;&nbsp;23993人付款</p>
                                        </div>
                                        <div class="one_fifth columns">
                                            <div class="price-cart-wrapper">
                                	...
                                	<div class="product-list-wrapper">
                                        <div class="one_fifth columns product-img">
                                            <a title="Casio/卡西欧EX-ZR3700自拍美颜相机 自拍神器数码相机" href="product-details.aspx"><img src="images/content/products/p-38.jpg" alt=""/></a>
                                        </div>
                                        <div class="three_fifth columns">
                                        	<div class="status"><span>品牌</span> &nbsp;&nbsp;| &nbsp;&nbsp;卡西欧</div>
                                            <h3><a title="Casio/卡西欧EX-ZR3700自拍美颜相机 自拍神器数码相机" href="product-details.aspx">Casio/卡西欧EX-ZR3700自拍美颜相机 自拍神器数码相机</a></h3>
                                            <p>淘宝网商城,旗舰品牌入驻,爆款手机,强劲配置,热卖机型,正品行货,性价比超高!网购手机,来「天猫手机馆」让人放心的手机商城.采购批发找电子产品<br />电子产品从原料,生产,加工一系列服务.找阿里巴巴,全球领先采购批发平台.<br />深圳 &nbsp;&nbsp;23993人付款</p>
                                        </div>
                                        <div class="one_fifth columns">
                                            <div class="price-cart-wrapper">
                                                <div class="price">￥1410.00</div>
                                                <form action="index.aspx" class="compare">
                                                <input type="checkbox" value="12" id="comparator_item_12" class="comparator" onclick="checkForComparison(3)"> 
                                                <label>感兴趣</label>
                                                </form>
                                	...
                                	<div class="product-list-wrapper">
                                        <div class="one_fifth columns product-img">
                                            <a title="国行 Fujifilm/富士 X100F x100t X-100T X100F旁轴相机" href="product-details.aspx"><img src="images/content/products/p-39.jpg" alt=""/></a>
                                        </div>
                                        <div class="three_fifth columns">
                                        	<div class="status"><span>品牌</span> &nbsp;&nbsp;| &nbsp;&nbsp;富士</div>
                                            <h3><a title="国行 Fujifilm/富士 X100F x100t X-100T X100F旁轴相机" href="product-details.aspx">国行 Fujifilm/富士 X100F x100t X-100T X100F旁轴相机</a></h3>
                                            <p>淘宝网商城,旗舰品牌入驻,爆款手机,强劲配置,热卖机型,正品行货,性价比超高!网购手机,来「天猫手机馆」让人放心的手机商城.采购批发找电子产品<br />电子产品从原料,生产,加工一系列服务.找阿里巴巴,全球领先采购批发平台.<br />深圳 &nbsp;&nbsp;23993人付款</p>
                                        </div>
                                        <div class="one_fifth columns">
                                            <div class="price-cart-wrapper">
                                                <div class="price">￥7780.00</div>
                                                <form action="index.aspx" class="compare">
                                                <input type="checkbox"  class="comparator" > 
                                                <label>感兴趣</label>
                                                </form>
                            ...
                            <li class="widget-container">
                                ...
                                <ul>
                                    ...
                                    <li><a href="product-camera.aspx">摄影、摄像 (4)</a>
                                         <ul>
                                            <li><a href="product-list-digitalcamera.aspx">数码相机 (4)</a></li>
                                        </ul>
                                    </li>
