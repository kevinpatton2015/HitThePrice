                            ...
                            <form runat="server">
                                ...
                                <div class="row">
                                    <div class="five columns ">
                                        <label for="billing_first_name" class="">姓名 <span class="required">*</span></label>
                                    ...
                                    <div class="ten columns ">
                                        <label for="billing_company" class="">公司</label>
                                        <input type="text" class="input-text" name="billing_company" id="billing_company"  value="" runat="server"/>
                                        
                                    </div>
                                    <div class="clear"></div>
                                    <div class="five columns ">
                                        <label for="billing_address_1" class="">地址 <span class="required">*</span></label>
                                        <input type="text" class="input-text" name="billing_address_1" id="billing_address_1"  value="" runat="server"/>
                                    </div>
                                    <div class="five columns ">
                                        <label for="billing_address_2" class="hidden">地址2</label>
                                        <input type="text" class="input-text" name="billing_address_2" id="billing_address_2"  value="" runat="server"/>
                                    </div>
                                    <div class="clear"></div>
                                    <div class="five columns ">
