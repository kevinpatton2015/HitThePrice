                ...
                <div class="row">
                	<section id="maincontent" class="twelve columns">
                        ...
                        <section class="content">
                            ...
                            <div class="breadcrumb"><a href="index.html">Home</a>  /  About / Elements</div>
                           ...
                           <div class="row">
                                	<div class="one_half columns">
                                        ...
                                        <div class="tabcontainer">
                                            <ul class="tabs">
                                                <li class="active"><a href="#tab0">First</a></li>
                                            ...
                                            <div class="tab-body">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis feugiat rutrum luctus. Proin nisl augue, tempus quis lacinia at, ultrices eget sapien. Vestibulum at orci a eros molestie rutrum. Fusce interdum erat vel eros elementum vitae interdum massa varius. </p>
                                                </div>
                                    ...
                                    <div class="one_half columns">
                                        ...
                                        <h2>Toogles</h2>
                                        <div id="toggle">
                                            <h2 class="trigger"><span>01</span>Easy to Customize</h2>
                                            ...
                                            <h2 class="trigger"><span>02</span>Quick and convenient Localization Support</h2>
                                            <div class="toggle_container">
                                                <div class="block">
                                                    <p>Consequat te olim letalis premo ad hos olim odio olim indoles ut venio iusto. Euismod, sagaciter diam neque antehabeo blandit, jumentum transverbero luptatum. Lenis vel diam praemitto molior facilisi facilisi suscipere abico, ludus, at. Wisi suscipere nisl ad capto comis esse, autem genitus. Feugiat immitto ullamcorper hos luptatum gilvus eum. Delenit patria nunc os pneum acsi nulla magna singularis proprius autem exerci accumsan.</p>
                                                    <p>Praesent duis vel similis usitas camur, nostrud eros opes verto epulae feugiat ad. Suscipit modo magna letalis amet et tego accumsan facilisi, meus. Vindico luptatum blandit ulciscor mos caecus praesent sed meus velit si quis lobortis praemitto, uxor.</p>
                                            ...
                                            <h2 class="trigger"><span>03</span>Compatible with the latest WordPress Version</h2>
                                            <div class="toggle_container">
                                                <div class="block">
                                                    <p>Consequat te olim letalis premo ad hos olim odio olim indoles ut venio iusto. Euismod, sagaciter diam neque antehabeo blandit, jumentum transverbero luptatum. Lenis vel diam praemitto molior facilisi facilisi suscipere abico, ludus, at. Wisi suscipere nisl ad capto comis esse, autem genitus. Feugiat immitto ullamcorper hos luptatum gilvus eum. Delenit patria nunc os pneum acsi nulla magna singularis proprius autem exerci accumsan.</p>
                                                    <p>Praesent duis vel similis usitas camur, nostrud eros opes verto epulae feugiat ad. Suscipit modo magna letalis amet et tego accumsan facilisi, meus. Vindico luptatum blandit ulciscor mos caecus praesent sed meus velit si quis lobortis praemitto, uxor.</p>
                                            ...
                                            <h2 class="trigger"><span>04</span>Attuned to Smartphones and Tablet PCs</h2>
                                            <div class="toggle_container">
                                                <div class="block">
                                                    <p>Consequat te olim letalis premo ad hos olim odio olim indoles ut venio iusto. Euismod, sagaciter diam neque antehabeo blandit, jumentum transverbero luptatum. Lenis vel diam praemitto molior facilisi facilisi suscipere abico, ludus, at. Wisi suscipere nisl ad capto comis esse, autem genitus. Feugiat immitto ullamcorper hos luptatum gilvus eum. Delenit patria nunc os pneum acsi nulla magna singularis proprius autem exerci accumsan.</p>
                                                    <p>Praesent duis vel similis usitas camur, nostrud eros opes verto epulae feugiat ad. Suscipit modo magna letalis amet et tego accumsan facilisi, meus. Vindico luptatum blandit ulciscor mos caecus praesent sed meus velit si quis lobortis praemitto, uxor.</p>
                            	...
                            	<div class="row">
                                	<div class="one_half columns">
                                        ...
                                        <img src="images/content/pic.jpg" alt="" class="alignleft frame" />
                                        <p>Phasellus fringilla suscipit risus nec eleifend. Pellentesque eu quam sem, ac malesuada leo. Sed ut quam at magna porttitor hendrerit.</p>
                                        <p>Maecenas quis erat fringilla augue feugiat vulputate a eu sem. Pellentesque vmolestie lacus vestibulum velit fringilla tincidunt. Nunc et pharetra lorem. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc semper lobortis sodales. Fusce convallis felis quis diam tempus auctor. Nam placerat posuere mi, vel lacinia justo sagittis sit amet.</p>
                                    </div>
                                    <div class="one_half columns">
                                    	<h2>Tables</h2>
                                        <table>
                                ...
                                <div class="one_half columns">
                                    ...
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse id leo sem. In non eros viverra orci consequat sagittis sed sed lectus. Mauris tempus eleifend elit, ut fringilla nunc commodo sed. Nunc quam nunc, auctor id fringilla ut, faucibus euismod felis.
                                </div>
                                <div class="one_half columns">
                                ...
                                <div class="one_third columns">
                                    ...
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse id leo sem. In non eros viverra orci consequat sagittis sed sed lectus. 
                                </div>
                                <div class="one_third columns">
                                ...
                                <div class="row">
                                    <div class="one_fourth columns">
										<h4>Four Columns</h4>
                                        Donec iaculis interdum sapien, ac molestie erat porttitor et. Duis convallis ante vel purus pellentesque quis gravida ligula consequat.
                                    </div>
                                    <div class="one_fourth columns">
										<h4>Four Columns</h4>
                                        Donec iaculis interdum sapien, ac molestie erat porttitor et. Duis convallis ante vel purus pellentesque quis gravida ligula consequat.
                                ...
                                <div class="row">
                                    <div class="one_third columns">
                                    <span class="dropcap1">L</span>orem ipsum dolor sit amet, consectetuer adipiscing elit. Nullam dignissim convallis est. Quisque aliquam. This is a blockquote. Aenean arcu elit, tristique semper pulvinar adipiscing. Donec faucibus. Nam sit amet sem. Aliquam libero nisi, imperdiet.
                                    </div>
                                    <div class="one_third columns">
                                    <span class="dropcap2">L</span>orem ipsum dolor sit amet, consectetuer adipiscing elit. Nullam dignissim convallis est. Quisque aliquam. This is a blockquote. Aenean arcu elit, tristique semper pulvinar adipiscing. Donec faucibus. Nam sit amet sem. Aliquam libero nisi, imperdiet.
                                    </div>
                                    <div class="one_third columns">
                                    <span class="dropcap3">L</span>orem ipsum dolor sit amet, consectetuer adipiscing elit. Nullam dignissim convallis est. Quisque aliquam. This is a blockquote. Aenean arcu elit, tristique semper pulvinar adipiscing. Donec faucibus. Nam sit amet sem. Aliquam libero nisi, imperdiet.
                                    </div>
                                </div>
                                ...
                                <h2>Blockquotes</h2>
                                       ...
                                       <p>Nulla porta, ipsum sit amet suscipit ornare, metus quam volutpat mauris, placerat dignissim erat orci id est. Curabitur egestas condimentum erat at feugiat. Nulla sagittis tristique tortor eu aliquam. Aliquam ac hendrerit justo. Praesent in nibh est, eget venenatis enim. Sed vel ipsum vitae purus rutrum tempus id convallis est. Quisque id quam nisi, vel tincidunt nunc.</p>

<p>Nam vel lectus neque, non sagittis sapien. Aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin in leo elit, in convallis leo. Etiam ac lacus nulla, id venenatis felis. Aliquam vel sapien ligula. Vestibulum condimentum condimentum nisi nec pellentesque. Ut ultrices rhoncus viverra.</p>

										<blockquote> Praesent vel nisl vel orci consequat fringilla a vel nulla. Morbi at erat eu eros blandit consequat at et eros. Donec hendrerit metus ac ligula cursus.</blockquote>
								
                                <p>Cras vitae ligula non risus luctus accumsan. Morbi porta lorem ac nisl elementum volutpat. Donec risus lorem, dictum vel semper eget, tincidunt non quam. Integer pharetra, nisl vitae aliquam fringilla, lectus mauris pretium nunc, vitae malesuada lacus nisi eu lectus. Sed consectetur sollicitudin nisi nec hendrerit. Fusce gravida, massa vitae consectetur fringilla, elit mi cursus turpis, non convallis massa risus sed dolor. Morbi at enim interdum risus dictum pulvinar.</p>

<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis dui a purus imperdiet venenatis. Phasellus non nisl est. Ut dignissim tortor vel purus tempor ornare at mattis turpis. I</p>
